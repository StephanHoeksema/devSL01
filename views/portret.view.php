...
<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <div id="profile"
        ...
        <div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <!-- TODO Add image good size for mobile -->
            <div>
                <img src="/public/ing/STEPHAN.jpg"
                     alt=""
                     class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center">
            </div>

            <h1 class="text-3xl font-bold pt-8 lg:pt-0">Stephan Paul Hoeksema</h1>
            ...
            <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                ...
                Teacher AD Software Development
            </p>
    ...
    <div class="w-full lg:w-2/5">
        ...
        <img src="/public/ing/STEPHAN.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
